...
var _default = Pacman;
exports.default = _default;
},{"@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./setup":"setup.js"}],"GhostsMoves.js":[function(require,module,exports) {
"use strict";
...
var _GhostsMoves = require("./GhostsMoves");
...
function checkCollition(pacman, ghosts) {
...
function gameLoop(pacman, ghosts) {
  ...
  if (pacman.powerPill !== powerPillTimer) {
    powerPillTimer = pacman.powerPill;
    ghosts.forEach(function (ghost) {
...
function startGame() {
  ...
  var ghosts = [new _Ghost.default(5, 188, _GhostsMoves.randomMovement, _setup.OBJECT_TYPE.BLINKY), new _Ghost.default(4, 209, _GhostsMoves.randomMovement, _setup.OBJECT_TYPE.PINKY), new _Ghost.default(3, 251, _GhostsMoves.randomMovement, _setup.OBJECT_TYPE.INKY), new _Ghost.default(2, 230, _GhostsMoves.randomMovement, _setup.OBJECT_TYPE.CLYDE)];
